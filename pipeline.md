# Pipeline du projet — Benchmark de SLM pour l'analyse financière
...
- [🏗️ Architecture du système](#️-architecture-du-système)
  ...
  - [Étape 1 — Ingestion](#étape-1--ingestion)
  - [Étape 2 — Génération (4 agents)](#étape-2--génération-4-agents)
  - [Étape 3 — Évaluation : deux pipelines indépendants](#étape-3--évaluation--deux-pipelines-indépendants)
  - [Étape 4 — Rapport comparatif](#étape-4--rapport-comparatif)
  - [Déploiement — Application web](#déploiement--application-web)
...
- **Pipeline resilient** : reprise automatique après interruption, aucune inférence
